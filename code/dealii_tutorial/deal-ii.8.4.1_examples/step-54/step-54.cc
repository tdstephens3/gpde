...
namespace Step54
{
  ...
  {
    TopoDS_Shape bow_surface = OpenCASCADE::read_IGES(cad_file_name, 1);
  ...
  try
    {
      ...
      cout << "----------------------------------------------------------" << endl;
      std::string out_mesh_filename = ( "ellipsoid_normal_projection" );
      ...
      //cout << "----------------------------------------------------------" << endl;
      //out_mesh_filename = ( "ellipsoid_directional_projection" );
      ...
      //cout << "----------------------------------------------------------" << endl;
      //out_mesh_filename = ( "ellipsoid_normal_to_mesh_projection" );
