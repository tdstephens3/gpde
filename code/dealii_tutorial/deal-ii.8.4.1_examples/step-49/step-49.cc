...
void grid_2 ()
{
  ...
  print_mesh_info(tria1, "grid-2.eps");
  ...
  //Triangulation<2> triangulation_refined;
  //triangulation_refined.copy_triangulation (triangulation); 
  //triangulation_refined.refine_global (2);
  //print_mesh_info(triangulation_refined, "grid-2r.eps");
}
