...
int main ()
{
  ...
  // compute the laplacian of the identity on each cell
  for (; cell!=endc; ++cell)
  {

    fe_values.reinit (cell);
    Vector<double> identity_on_manifold;        

    std::vector< Vector<double> >  laplacians; 
    fe_values.get_function_laplacians(identity_on_manifold,laplacians);
  }
